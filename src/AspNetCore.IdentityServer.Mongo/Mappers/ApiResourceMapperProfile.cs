namespace AspNetCore.IdentityServer.Mongo.Mappers
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResourceMapperProfile"/> class.
        /// </summary>
        public ApiResourceMapperProfile()
        {
            ...
            CreateMap<Entities.ApiResource, Duende.IdentityServer.Models.ApiResource>(MemberList.Destination)
            ...
            CreateMap<Entities.ApiResourceSecret, Duende.IdentityServer.Models.Secret>(MemberList.Destination)
