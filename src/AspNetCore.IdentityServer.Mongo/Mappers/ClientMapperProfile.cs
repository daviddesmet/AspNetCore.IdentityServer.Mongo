namespace AspNetCore.IdentityServer.Mongo.Mappers
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientMapperProfile"/> class.
        /// </summary>
        public ClientMapperProfile()
        {
            ...
            CreateMap<Entities.Client, Duende.IdentityServer.Models.Client>()
            ...
            CreateMap<Entities.ClientClaim, Duende.IdentityServer.Models.ClientClaim>(MemberList.None)
            ...
            CreateMap<Entities.ClientSecret, Duende.IdentityServer.Models.Secret>(MemberList.Destination)
